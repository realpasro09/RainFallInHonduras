...
namespace Rainfall.Web.Specs
{
    public class when_getting_rainfall_data_by_period_and_location
    {
        ...
        Because of = () => _result = _rainfallController.GetRainfallData(_locationId, (int)PeriodType.LastYear,_tableParams);

        It should_return_filtered_data_by_location_and_period = () => _result.Data.ShouldBeLike(_expectecAlmanacDayGridSummaryModel);
