...
function userController($scope) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [{ field: 'name', displayName: 'Very Long Name Title', sortable: false},
                     { field: 'allowance', width: 120, aggLabelFilter: 'currency', cellTemplate: '<div ng-class="{red: row.entity[col.field] > 30}"><div class="kgCellText">{{row.entity[col.field] | currency}}</div></div>' },
